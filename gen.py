...
<header id="navbar" class="scroll-nav fixed top-0 left-0 w-full z-50 glass-nav">
    <div class="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="ngonngu flex items-center space-x-1">
                <a href="https://tanmygroup.com.vn/" title="Tiếng Việt" class="block leading-none"><img src="data:image/png;base64," alt="Tiếng Việt" width="16" height="11" style="width:16px;height:11px"></a>
                <a href="https://tanmygroup.com.vn/en/home/" title="English" class="block leading-none"><img src="data:image/png;base64," alt="English" width="16" height="11" style="width:16px;height:11px"></a>
            </div>
