...
<header id="navbar" class="scroll-nav fixed top-0 left-0 w-full z-50 glass-nav">
    <div class="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="flex items-center space-x-1 border border-gray-300 px-2 py-0.5 rounded bg-gray-50">
                <span class="cursor-pointer flex items-center" title="Tiếng Việt">
                    <img src="https://flagcdn.com/vn.svg" alt="VN" class="w-5 h-auto rounded-sm shadow-sm">
                </span>
                <span class="text-gray-300 text-xs">|</span>
                <span class="cursor-pointer flex items-center" title="English">
                    <img src="https://flagcdn.com/gb.svg" alt="EN" class="w-5 h-auto rounded-sm shadow-sm">
                </span>
            </div>
